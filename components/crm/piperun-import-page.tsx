  ...
  return (
    <section className="grid gap-6">
      <section className="executive-surface rounded-md p-5 text-card-foreground sm:p-6">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
          ...
          <div className="rounded-md border bg-background/70 p-3 text-sm text-muted-foreground">
            ...
            <p className="mt-1">Aba: {preview.summary.sheetName}</p>
          </div>
        </div>
        ...
        <div className="mt-5 rounded-md border border-brand-gold/40 bg-background/70 p-4 text-sm leading-6 text-muted-foreground">
          <div className="flex items-start gap-3">
            ...
            <p>
              O arquivo atual nao possui coluna de telefone. Como a regra
              oficial bloqueia registros sem telefone, os registros ficam
              sinalizados para revisao antes de qualquer importacao real.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="grid gap-6 xl:grid-cols-3">
        <DistributionCard title="Registros por status" values={preview.summary.statusCounts} />
      ...
      <section className="executive-surface rounded-md p-5 text-card-foreground sm:p-6">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
          ...
          <Button disabled type="button" variant="secondary">
            Importacao ainda bloqueada — revise a previa antes.
          </Button>
        </div>
